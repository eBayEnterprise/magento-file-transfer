<?php
class EbayEnterprise_FileTransfer_Test_Model_Protocol_ConfigTest extends EcomDev_PHPUnit_Test_Case
{
	...
	public function setUp()
	{
		$this->class = new ReflectionClass(
			'EbayEnterprise_FileTransfer_Model_Protocol_Config'
		);
	...
	public function testValidateProtocolCodeException()
	{
		...
		$this->setExpectedException(
			'EbayEnterprise_FileTransfer_Exception_Configuration',
